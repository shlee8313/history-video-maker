...
import {
  ...
  scaleIn,
  cameraZoom,
} from "../remotion/src/lib/animations";
...
export const S17: React.FC = () => {
  ...
  return (
    <AbsoluteFill>
      ...
      >
        <Img
          src={staticFile("assets/images/ttong_janggun.png")}
          style={{
      ...
      >
        <Img
          src={staticFile("assets/images/royal_janggun.png")}
          style={{
            width: IMAGE_SIZES.artifactLarge,
            height: "auto",
